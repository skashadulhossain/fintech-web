        ...
        <div>
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            <p style={{ marginTop: "0.5rem" }}>
              ...
              transactions through NEFT and IMPS. With a strong presence across
              multiple cities, our services are easily accessible, allowing
              customers to send money conveniently from our widespread outlets.
              Whether for urgent transfers or regular transactions, our DMT
              service is designed to deliver speed, security, and reliability
              every time.
            </p>
              ...
              <div>
                ...
                <div className="advantage-two">
                  <span>
                    ...
                    <span style={{ fontWeight: 600 }}>Simple Onboarding:</span>
                  ...
                  <span>
                    ...
                    <span style={{ fontWeight: 600 }}>24/7 Auto Billing:</span>
                  ...
                  <span>
                    ...
                    Available beyond banking hours, including Sundays and public
                    holidays.
                  </span>
                </div>
              </div>
          ...
          <div className="dmt-container">
            ...
            <div>
              <h2 style={{ marginBottom: "2rem" }}>Money Transfer Features</h2>
              <div className="dmt-card">
                <div>
                  ...
                  <p style={{ fontSize: "14px" }}>
                    ...
                    to any bank account by paying in cash through this feature.
                  </p>
                </div>
                <div>
                ...
                <div>
                  <img src="/images/integration.png" alt="" className="logo" />
                  <h4 style={{ padding: "8px 0px 8px 0px" }}>
                    Seamless Integration
                  </h4>
                  <p style={{ fontSize: "14px" }}>
                    Our Money Transfer API, based on JSON, is easy to integrate
                    for developers. Its well-documented and easy to use, with
                    24/7 support for integration.
                  </p>
                </div>
              </div>
            </div>
